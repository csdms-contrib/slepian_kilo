...
if ~isstr(S)
    ...
    if nargout > 2
        ...
        kyy = ky2 / 2 * params.dydx(1);
        kxx = kx2 / 2 * params.dydx(2);
    ...
    for in = 1:size(S, 2)
        ...
        if round(blurs) == blurs && ...
            ...
            if any(HhI < 0);
                error('Convolved variance kernel contains negatives');
            end
        ...
        if xver == 1 || xver == 2
            ...
            kzx2 = floor(NyNx2(2)/2) + 1;
            kzy2 = floor(NyNx2(1)/2) + 1;
